# Conversaition Architecture

This document describes the technical architecture, system design, and implementation roadmap for the Conversaition multi-AI conversation platform.
...
- **Custom Streaming Protocol**: LangGraph → AI SDK adapter for real-time events
...
**Key Features**:
- Custom LangGraph → AI SDK protocol adapter
...
class ConversationSSEManager:
    def __init__(self):
        ...
        self.ai_sdk_adapter = LangGraphToAISDKAdapter()
        ...
        async def event_generator():
            try:
                while True:
                    ...
                    # Custom adapter: LangGraph → AI SDK protocol
...
- [x] Initialize Python project structure with Docker setup
- [x] Set up FastAPI backend with async support
...
- [x] LangGraph conversation graph setup
- [x] Basic ConversationState management
- [x] AI Provider integration within LangGraph nodes:
  - [x] OpenAI (langchain-openai)
  - [x] Anthropic Claude (langchain-anthropic)
  - [x] Google Gemini (langchain-google-genai)
  - [ ] Local model support (custom adapters)
- [x] Simple participant management in graph state

#### Sprint 1.3: SSE Streaming with AI SDK Integration
- [x] Research AI SDK stream protocol specification
- [x] Design LangGraph → AI SDK event mapping
- [x] Implement custom LangGraphToAISDKAdapter class
- [x] SSE streaming setup with sse-starlette
- [x] Test adapter with basic LangGraph events
- [x] REST API endpoints for conversation operations
- [x] Multi-participant SSE connection management
...
- [x] Next.js frontend setup with App Router
- [x] AI SDK integration (@ai-sdk/react, @ai-sdk/ui)
- [x] Custom SSE connection handling for multi-participant conversations
- [x] Test frontend with LangGraph → AI SDK adapter
- [x] Basic conversation UI components
- [ ] LlamaIndex Chat UI integration

#### Sprint 2.2: Multi-Participant UI
- [x] Multi-participant conversation interface
- [x] Real-time participant status display
- [x] Message attribution and participant identification
- [x] Basic conversation controls (pause/resume)
- [x] Connection recovery and state synchronization

#### Sprint 2.3: Weighted Round-Robin in LangGraph
- [x] Advanced scheduling algorithm in conversation graph
- [x] Participant weight configuration
- [x] Turn management within LangGraph flow
- [x] Anti-spam conversation flow controls
...
- [x] Participant pool management
- [ ] Conversation templates with LangGraph configurations
- [x] Enhanced AI participant system prompts with expertise roles
